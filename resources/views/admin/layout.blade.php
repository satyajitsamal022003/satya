                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form method="POST" action="{{ route('admin.logout') }}">
                            ...
                            <a class="dropdown-item" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
                                                this.closest('form').submit();" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                        </form>
                    </div>
                </div>
            </div>
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Design & Develop by Iconify Technology.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{url('/')}}/assets/libs/jsvectormap/maps/us-merc-en.js"></script>

     <!-- Swiper Js -->
     <script src="{{url('/')}}/assets/libs/swiper/swiper-bundle.min.js"></script>
    <script src="{{url('/')}}/assets/js/pages/form-input-spin.init.js"></script>
    <script src="{{url('/')}}/assets/libs/card/card.js"></script>

    <!-- Widget init -->
    <script src="{{url('/')}}/assets/js/pages/widgets.init.js"></script>
